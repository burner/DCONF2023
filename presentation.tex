...
they are not. Most languages are safe already, python, JS, java
	...
	\begin{frame}[fragile]{returning ref}
		...
		\pause
		\lstinputlisting[language=D,,firstnumber=1,firstline=28,lastline=34,basicstyle=\scriptsize\ttfamily]{containerref.d}
		\end{column}
		\end{columns}
	\end{frame}
	...
	\begin{frame}[t]
		...
		\lstinputlisting[language=D,firstnumber=1,firstline=1,lastline=19,basicstyle=\scriptsize\ttfamily]{nestedfunction.d}
